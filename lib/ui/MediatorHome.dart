...
class MediatorHome extends StatefulWidget {
  @override
  _MediatorHomeState createState() => new _MediatorHomeState();
}

class _MediatorHomeState extends State<MediatorHome> {
        ...
        onResume: (Map<String, dynamic> message) async {
          //print("On Resume Ya Osssssss");
            print("onResume: $message");
             Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => MediatorHome()));
            if(Platform.isAndroid){
    ...
    return Container(
        ...
        child: Column(children: [
          ...
          appButtonbgimage(
              'عملاء مميزون',
              () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => Special_users())),
          ...
          shareAppButtonbgimage(
              ' مشاركه التطبيق',
              () =>Share.share(
  content.shareApp, subject: 'تطبيق تسويق عقاري ',
  sharePositionOrigin: Rect.fromCenter(center: Offset(100, 100), width: 100, height: 100),
),//Share.share(content.shareApp, subject: 'تطبيق تسويق عقاري '),
              bgColor: desgin_button1_start, bgColor2: desgin_button1_end),
        ]));
  }
}
