...
class AllAvailableOffersNewDesign extends StatefulWidget {
  @override
  _AllAvailableOffersNewDesignState createState() => new _AllAvailableOffersNewDesignState();
}

class _AllAvailableOffersNewDesignState extends State<AllAvailableOffersNewDesign> {

  BuildContext _context;
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  //UnboundedScrollController _negativeController = new UnboundedScrollController();

    Widget _appBarTitle = new Text( 'الطلبات و العروض' );
...
List<ServiceDataVM> servicesData = List<ServiceDataVM>();
  ...
  final TextEditingController _filter2 = new TextEditingController();
...
search(){
  ...
  print(searchTxt);
  ServiceDataApi.Search(searchTxt , _selectedDistrictId , _selectedGovernmentId , _selectedCountryId ,0).then((response) {
        if (response.code ==200 ) {
