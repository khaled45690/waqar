...
class My_services_06 extends StatefulWidget {
  @override
  _My_services_06State createState() => new _My_services_06State();
}

class _My_services_06State extends State<My_services_06> {
...
int _radioValueForSell = -1;
   int _radioValueForRent = -1;
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          appButtonbgimage('نموذج طلب إداره املاك عقار', () => {},
