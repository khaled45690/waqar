...
class ServicesDataThatUserAccepted extends StatefulWidget {
  String userId;
  ServicesDataThatUserAccepted(this.userId);
  @override
  _ServicesDataThatUserAcceptedState createState() => new _ServicesDataThatUserAcceptedState();
}

class _ServicesDataThatUserAcceptedState extends State<ServicesDataThatUserAccepted> {
...
//    };
  ...
  @override
  void dispose() {
//    _bloc.ServicesDataThatUserAcceptedubject.close();
//    _bloc.dispose();
    super.dispose();
  }
