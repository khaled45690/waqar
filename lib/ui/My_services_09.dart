...
class My_services_09 extends StatefulWidget {
  @override
  _My_services_09State createState() => new _My_services_09State();
}

class _My_services_09State extends State<My_services_09>
...
bool _radioValueForEducational = false;
bool _radioValueForEntertainment = false;
  int _radioValue2 = -1;
  int _radioValue3 = -1;
  int _radioValue4 = -1;
 int _radioValue1 = -1;
                        ...
                        children: <Widget>[
                          Container(
                              ...
                              child: Column(
                                  ...
                                  children: <Widget>[
                                    appButtonbgimage('نموذج طلب صيانه عقار', () => {},
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: <Widget>[
                Checkbox(
                  value: _radioValueForEntertainment,
                  onChanged: (bool newValue) {
                    setState(() {
                      _radioValueForEntertainment = newValue;
                    });
                  }),
                Text(
                  'ترفيهي',
                ...
                Checkbox(
                  value: _radioValueForEducational,
                  onChanged: (bool newValue) {
                    setState(() {
                      _radioValueForEducational = newValue;
                    });
                  }),
                Text(
                  'تعليمي',
...
UserVM userVM ;
  ...
  Submit() {
    ...
    if(aqartypeKey.currentState.value==null || aqartypeKey.currentState.value ==""){
      ...
      model.BuildingPrice=0;//double.parse(price);
    ...
    }if(_radioValueForEntertainment){
      model.IsEntertainment = true;
    }if(_radioValueForEducational){
      model.IsEducational = true;
    }
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              onPressed: () {
                ...
                //     .push(MaterialPageRoute(builder: (context) => My_services_09()));
              },
            ),
