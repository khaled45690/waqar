...
class My_Service_08_Details extends StatefulWidget {
  ServiceDataVM serviceData;
  My_Service_08_Details(this.serviceData);
  @override
  _My_Service_08_DetailsState createState(){
    try{
      set();
    }catch(ex){

    }
    return _My_Service_08_DetailsState();
  } 
}

class _My_Service_08_DetailsState extends State<My_Service_08_Details>
          ...
          children: [
            ...
            Row(
              children: <Widget>[
                Radio(
                  value: 3,
                  groupValue:  widget.serviceData.IsEntertainment?3:-1,//_radioValue2,
                //  onChanged: _handleRadioValueChange2,
                ),
                Text(
                  'ترفيهي',
                ...
                Radio(
                  value: 4,
                  groupValue:  widget.serviceData.IsEducational?4:-1,//_radioValue2,
                //  onChanged: _handleRadioValueChange2,
                ),
                Text(
                  'تعليمي',
...
print("ENNNNNNNNNNNNNNNNNNNNNNNNNNNNNn");
  print(widget.serviceData.IsEntertainment);
  print(widget.serviceData.IsEducational);
    ...
    if(widget.serviceData.AddDuration==10){
      ...
      _radioValue3=2;
    }else if(widget.serviceData.AddDuration==60){
      _radioValue3=3;
    }
  //////
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              onPressed: () {
                ...
                //     .push(MaterialPageRoute(builder: (context) => My_Service_08_Details()));
              },
            ),
