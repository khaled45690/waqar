...
class ServicesDataThatUserAcceptedNewDesign extends StatefulWidget {
  String userId;
  ServicesDataThatUserAcceptedNewDesign(this.userId);
  @override
  _ServicesDataThatUserAcceptedNewDesignState createState() => new _ServicesDataThatUserAcceptedNewDesignState();
}

class _ServicesDataThatUserAcceptedNewDesignState extends State<ServicesDataThatUserAcceptedNewDesign> {
...
bool apiCall = true ;
  ...
  void initState() {
    ...
    getUser().then((user){
      ...
      print(user.Id);
              ServiceDataApi.ServicesDataThatUserAccepted(user.Id).then((ss){
                if(ss.code !=200){
...
//    };
  ...
  @override
  void dispose() {
//    _bloc.ServicesDataThatUserAcceptedNewDesignubject.close();
//    _bloc.dispose();
    super.dispose();
  }
