...
class My_Service_01_Details extends StatefulWidget {
  ServiceDataVM serviceData;
  My_Service_01_Details(this.serviceData);
  @override
  _My_Service_01_DetailsState createState(){
    try{
      set();
    }catch(ex){

    }
    return _My_Service_01_DetailsState();
  } 
}

class _My_Service_01_DetailsState extends State<My_Service_01_Details>
  ...
  Widget _buildCard() => SizedBox(
        ...
        widget.serviceData.ServiceId==1?Row(
          ...
          children: <Widget>[
            ...
            widget.serviceData.ServiceId==5?Container(): Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Expanded(
                        ...
                        appButtonbgimage(
                          ...
                          () async {
                             try{
                               if(userVM==null||userVM.Email.toString()==null||userVM.Email.toString()==""||userVM.Email==null){
                                    print("What You need");
                                    //showSnack("من فضلك قم بتسجيل الدخول" , duration: Duration(seconds: 10));
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              onPressed: () {
                ...
                //     .push(MaterialPageRoute(builder: (context) => My_Service_01_Details()));
              },
            ),
      ...
      child: new _SystemPadding(child: new AlertDialog(
            ...
            actions: <Widget>[
              ...
              onPressed: () {
                ...
                //      .push(MaterialPageRoute(builder: (_context) => AllAvailableOffersNewDesign()));
              },
            ),
            ],
          ),),
