...
class OfficeAcceptService extends StatefulWidget {
  int serviceId;
  OfficeAcceptService(this.serviceId);
  @override
  _OfficeAcceptServiceState createState() => new _OfficeAcceptServiceState();
}

class _OfficeAcceptServiceState extends State<OfficeAcceptService> {
...
void initState() {
  super.initState();
  AuthApi.GetServiceDataUsers(widget.serviceId).then((response){
              ...
              children: <Widget>[
                   ...
                   // height: 724,
                    ...
                    child: InkWell(
                         ...
                         MaterialPageRoute(builder: (context) => OfficeProfile(socialItem.Id)));
                          ...
                          child: Text("     "+socialItem.FullName , textDirection: TextDirection.rtl,),
                        ),
                ...
                new ClipRRect(
                    ...
                    child:socialItem.UserImage==null?Image.asset("asset15.png", height: 60,width: 50,):
                     Image.network(socialItem.UserImage, height: 60,width: 50,)
